...
**How to apply:** When adding tournament UI or endpoints, read stage configuration from the active tournament, validate progression against that ordered list, and keep team-level stats/name/champion identity in sync for 2v2 tournaments.